...
코딩으로 학습하는 GoF의 디자인 패턴 - 옵저버 패턴 1부<br/>
패턴 소개

**옵저버(Observer) 패턴: 다수의 객체가 특정 객체의 상태 변화를 감지하고 알림을 받는 패턴<br/>
...
코딩으로 학습하는 GoF의 디자인 패턴 - 옵저버 패턴 2부<br/>
패턴 적용하기
...
코딩으로 학습하는 GoF의 디자인 패턴 - 옵저버 패턴 3부<br/>
장점과 단점
...
코딩으로 학습하는 GoF의 디자인 패턴 - 옵저버 패턴 4부<br/>
자바에서 찾아보는 패턴
